export default function Contact() {
    return (
        <section className="py-10 text-black" id="contactanos">
            <div className="grid max-w-6xl grid-cols-1 mx-auto md:grid-cols-2 md:divide-x shadow-lg sm:rounded-xl sm:overflow-hidden">
                ...
                <form novalidate="" className="flex flex-col space-y-6 px-6 lg:px-8 py-6 ng-untouched ng-pristine ng-valid bg-white font-montserrat">
                    ...
                    <label className="block">
                        ...
                        <textarea placeholder="Qué tal! Necesito más información sobre sus soluciones tecnológicas, precios..." rows="6" className="block w-full rounded-lg shadow-md p-2"></textarea>
                    </label>
                    <button type="button" className="self-center px-8 py-3 text-lg rounded-full bg-gradient-to-r from-blue-800 via-blue-600 to-blue-400 text-white font-bold hover:from-blue-600 hover:via-blue-400 hover:to-blue-200 hover:text-black hover:font-bold">Enviar</button>
                </form>
            </div>
            {/* <div className="py-96">
